...
// Give canvas full width and height of parent
canvas.setDimensions({width: '100%', height: '100%'}, {cssOnly: true})
console.log(canvas.width);

// start here ---------------------------------------------------------------------------
function generateSection(e) {
  console.log('im generatSection');
...
var dragbtn = document.getElementById('dragbtn1');
dragbtn.addEventListener('mouseleave', generateSection);
